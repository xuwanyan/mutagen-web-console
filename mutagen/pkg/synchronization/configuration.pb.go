...
// GetDisableEmptyRootSafetyCheck returns whether the empty root safety check
// is disabled. This is a custom extension field (not serialized via protobuf).
func (x *Configuration) GetDisableEmptyRootSafetyCheck() bool {
	if x != nil {
		return x.DisableEmptyRootSafetyCheck
	}
	return false
}
